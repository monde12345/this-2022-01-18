...
class Person{
	...
	//두번째 클래스는 군번이 없는 경우 값을 0으로 준다.
	public Person(int juminNum,int bYear, int bMonth, int bDay) { //this 소괄호는 또 다른 객체를 생성하시오.
		...
		public void showInfo() {
			...
			System.out.println("생년연일: " + birthYear+ "/"+birthMonth+ "/"+birthDay);
